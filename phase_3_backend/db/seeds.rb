...
description: "Ema datshi is their national dish. It is a simple stew made of a variety of chilies and a special cheese, yak cheese, called datshi. Variations of this dish include potatoes (kewa datshi), beef, beans (semchung datshi) or mushrooms (shamu datshi).", 
...
description: "Its peaceful serene beauty and clean air, surrounded by unlevelled mountains, lush green fields and historical buildings make Paro the foremost popular destination in Bhutan. It is here in the city, where the only international airport can be found. Thus, Paro receives maximum number of tourists year round. There are frequent visits to the attractive dzongs such as Paro and Zuri.", 
country_id: bhutan.id)
Attraction.create(name: "Punakha", 
image_url: "https://www.tourmyindia.com/blog//wp-content/uploads/2017/04/Punakha-Dzong.jpg", description: "Another breathtaking destination in Bhutan is Punakha and this place is widely visited by adventure seekers. The best place to be for those who enjoy the adrenaline rush of river rafting in the two rivers/chhus, Mo and Pho. However, Punakha is widely famous for the 17th-century fortress Punakha Dzong which sits majestically besides the Pho and Mo Chhu.", 
country_id: bhutan.id)
Attraction.create(name: "Trongsa", 
image_url: "https://www.tourmyindia.com/blog//wp-content/uploads/2017/04/Trongsa-Dzong.jpg", 
description: "Trongsa sits in the central Bhutan and its lush flora creates a beautiful place to surround your senses and simply meditate. This must see place in Bhutan is conveniently placed in the centre with a strategic junction connecting roads to Bumthang, Gelephu and Punakha.", 
country_id: bhutan.id)
...
description: "It was while digging wells on the outskirts of Xi'an in the 1970s that farmers stumbled across what was to be China's most important archeological find: the Terracotta Army. Distributed over three large underground pits and built to guard the First Emperor's tomb, the find included more than 8,000 life-size warriors, some 520 horses, and more than 100 chariots.", 
country_id: china.id)
...
Attraction.create(name: "Nea Paphos", 
...
country_id: cyprus.id)
Attraction.create(name: "Tombs of the Kings", 
...
description: "The Tombs of the Kings is a large necropolis lying about two kilometres north of Paphos harbour in Cyprus. In 1980, it was designated a UNESCO World Heritage Site along with Paphos and Kouklia. The underground tombs, many of which date back to the 4th century BC, are carved out of solid rock.", 
country_id: cyprus.id)
...
Attraction.create(name: "Cathedral of Tbilisi", 
...
description: "Uplistsikhe is an ancient rock-hewn town in eastern Georgia, some 10 kilometers east of the town of Gori, Shida Kartli. Built on a high rocky left bank of the Mtkvari River, it contains various structures dating from the Early Iron Age to the Late Middle Ages.", 
country_id: georgia.id)
...
country_id: indonesia.id)
Attraction.create(name: "Sacred Monkey Forest", 
...
Attraction.create(name: "Friendship Bridge", image_url: "https://www.themaldivesexpert.com/wp-content/uploads/2019/03/bridge.jpg", description: "The Sinamalé Bridge links the islands of Malé, Hulhulé and Hulhumalé in the Maldives. It is an integral piece of infrastructure for connecting residents to other islands", country_id: maldives.id)
...
Attraction.create(name: "Church of Nativity", image_url: "https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcQnRRGVfb9lQss6tvu8cMZgzlP5OSvrYvqH2D5Me6vbOk7s39pMb1Ok_oSFbcrupQUbJ-ZM048X1zwRYUNJm3XOJA", description: "The Church of the Nativity, or Basilica of the Nativity, is a basilica located in Bethlehem in the West Bank, Palestine. The grotto it contains holds a prominent religious significance to Christians of various denominations as the birthplace of Jesus.", country_id: palestine.id)
Attraction.create(name: "Mar Saba Monastery", image_url: "https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcSgyMAPCSQRa2pZ0uhhzznKclDeUCxKXBrHS4hfeaPHBD5yHAPVTj2yeSJoxEDv_63_xUTZUNO-Dv7PaYAcofxBtQ", description: "The Holy Lavra of Saint Sabbas, known in Arabic and Syriac as Mar Saba and historically as the Great Laura of Saint Sabas, is a Greek Orthodox monastery overlooking the Kidron Valley in the Bethlehem Governorate of Palestine, in the West Bank, at a point halfway between Bethlehem and the Dead Sea.", country_id: palestine.id)
Attraction.create(name: "Dead Sea", image_url: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSGeRQ1_Wys_rK7ZWkTuZ0hTjc_cDnMOmoRBbx195UgsU5ZMAaZ8VMmBPvh8hzOgp4Bj1692pZPQr_Kw0D7AeeOtA", description: "The Dead Sea, also known by other names, is a salt lake bordered by Jordan to the east and Israel and the West Bank to the west. It lies in the Jordan Rift Valley, and its main tributary is the Jordan River. The lake's surface is 430.5 metres below sea level, making its shores the lowest land-based elevation on Earth.", country_id: palestine.id)

Food.create(name: "Shakshouka", image_url: "https://cdn.tasteatlas.com//Images/Dishes/16db5759e81b4166a0eb8bccaa211e6a.jpg?w=905&h=510", description: "Shakshouka is a dish of eggs poached in a sauce of tomatoes, olive oil, peppers, onion and garlic, commonly spiced with cumin, paprika and cayenne pepper.", country_id: palestine.id)
Food.create(name: "Mujaddara", image_url: "https://cdn.tasteatlas.com//images/dishes/a7adabed9df5481f98e3ce157202db03.jpg?w=905&h=510", description: "Mujaddara consists of cooked lentils together with groats, generally rice, and garnished with sautéed onions.", country_id: palestine.id)
Food.create(name: "Maqluba", image_url: "", description: "Maqluba or Maqlooba is a traditional Palestinian dish served throughout the Levant. It consists of meat, rice, and fried vegetables placed in a pot which is flipped upside down when served, hence the name maqluba, which translates literally as upside-down.", country_id: palestine.id)
...
Attraction.create(name: "Wat Arun", image_url: "http://www.exploreshaw.com/wp-content/uploads/2018/06/DSCF6802.jpg", description: "Wat Arun Ratchawararam Ratchawaramahawihan or Wat Arun is a Buddhist temple in Bangkok Yai district of Bangkok, Thailand.", country_id: thailand.id)
...
Food.create(name: "Pilaf", image_url: "https://caspiannews.com/media/caspian_news/all_original_photos/1504704604_8752604_1504704544_1206272pilaf.jpg", description: "Pilaf, also called “ash,” is the jewel in the crown of Turkmenistani cuisine. Similar to that found in the Turkic world, it comes in dozens of varieties, all which consist of two main ingredients: rice and meat.", country_id: turkmenistan.id)
Food.create(name: "Shashlyk", image_url: "https://caspiannews.com/media/caspian_news/all_original_photos/1504705119_720212_1504705009_601921turkmenskiy_shashlyk.jpg", description: "Shashlik, or shashlick, is a dish of skewered and grilled cubes of meat, similar to or synonymous with shish kebab.", country_id: turkmenistan.id)
Food.create(name: "Ishleki", image_url: "https://ingmar.app/blog/wp-content/uploads/2015/10/Turkmenistan-Ichlekli.jpg", description: "One of Turkmen shepherds' food is ichlekli (pronounced ishlekli), a meat pie that was traditionally baked buried in hot sand and embers. Nowadays, ichlekli is baked in the oven but the traditional technique is still kept alive by local enthusiasts.", country_id: turkmenistan.id)

Attraction.create(name: "Turkmen Carpet Museum", image_url: "https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcQN9fNK0RzYKkkr8CkBPORBRqb5ZAOZq9WSLY5uOqvGFnONuLhYqPo98imzzv4qAIZ3Gg4Z6ZtZ7yxJNFWze84T-Q", description: "The Turkmen Carpet Museum or the National Carpet Museum is a national museum, situated on 5 Gorogly Street in Ashgabat, Turkmenistan. The museum opened on 24 October 1994. It has the largest collection of Turkmen carpets of any museum.", country_id: turkmenistan.id)
Attraction.create(name: "Gonur Tepe", image_url: "https://encrypted-tbn0.gstatic.com/licensed-image?q=tbn:ANd9GcQezHVXG_192YSFYSacNvKkZcQlu890Kbi26-UzWL8bzIJ95xq4lWCzE8KrzIKOBuncQiNIatdtMdxMuNzs9JtQuA", description: "Gonur Depe is an archaeological site, dated from 2400 to 1600 BCE, and located about 60 km north of Mary, Turkmenistan consisting of a large early Bronze Age settlement.", country_id: turkmenistan.id)
Attraction.create(name: "Independence Monument", image_url: "https://encrypted-tbn0.gstatic.com/licensed-image?q=tbn:ANd9GcTHh7FFZ9ZqJY39RqlzhO2h7YrxxYvvYwVgwDk3oqTaYHHTcXqGfuZa8ehxZzPf_EMvTeSx_s4bogDafd91a8_L8w", description: "The Independence Monument is a monument located in Ashgabat, Turkmenistan. The design of this building was inspired by traditional Turkmen tents and the traditional headgear worn by Turkmen girls.", country_id: turkmenistan.id)
